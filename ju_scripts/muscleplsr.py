...
SHAPEFILESTR = 'muscle_data_Ju/shape_ipnode/gasL%dA%d.ipnode'
PREDSHAPEFILESTR = 'muscle_data_Ju/pred_shape_ipnode/pred_gasL%dA%d.ipnode'
STRAINFILESTR = 'muscle_data_Ju/strain/strainL%dA%d.exdata'
PREDSTRAINFILESTR = 'muscle_data_Ju/pred_strain/pred_strainL%dA%d.exdata'
STRESSFILESTR = 'muscle_data_Ju/stress/stressL%dA%d.exdata'
PREDSTRESSFILESTR = 'muscle_data_Ju/pred_stress/pred_stressL%dA%d.exdata'
