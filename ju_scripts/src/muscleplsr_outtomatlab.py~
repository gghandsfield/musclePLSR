...
responseName = 'stress'	#'geometry', 'stress', or 'strain'
...
# mydictX = {'X':X}
# mydictY = {'Y':Y}
# spio.savemat('strainX.mat',mydictX)
# spio.savemat('strainY.mat',mydictY)
...
for testInd, trainInd in xvalInds:
	...
	mydict = {}
	mydict['trainX'] = trainX
	mydict['testX'] = testX
	mydict['trainY'] = trainY
	mydict['testY'] = testY
	
	spio.savemat('stress_PLSRvars.mat',mydict) # stress_PLSRvars.mat or strain_PLSRvars.mat or geometry_PLSRvars.mat
